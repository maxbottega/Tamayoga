...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DownloadInt : FsmStateAction
	{
		...
		public override void OnUpdate()
		{
			...
			else if(web.isDone)
			{
				...
				loadValue = web.Load<int>(uniqueTag.Value);
				if(localFile.Value != "")
	...
	public class DownloadFloat: FsmStateAction
	{
		...
		public override void OnUpdate()
		{
			...
			{
				Fsm.Event(isDownloaded);
				loadValue = web.Load<float>(uniqueTag.Value);
				if(localFile.Value != "")
					web.SaveToFile(localFile.Value);
			}
		}
	...
	public class DownloadBool : FsmStateAction
	{
		...
		public override void OnUpdate()
		{
			...
			{
				Fsm.Event(isDownloaded);
				loadValue = web.Load<bool>(uniqueTag.Value);
				if(localFile.Value != "")
					web.SaveToFile(localFile.Value);
			}
		}
	...
	public class DownloadString: FsmStateAction
	{
		...
		public override void OnUpdate()
		{
			...
			{
				Fsm.Event(isDownloaded);
				loadValue = web.Load<string>(uniqueTag.Value);
				if(localFile.Value != "")
					web.SaveToFile(localFile.Value);
			}
		}
	...
	public class DownloadVector2: FsmStateAction
	{
		...
		public override void OnUpdate()
		{
			...
			{
				Fsm.Event(isDownloaded);
				loadValue = web.Load<Vector2>(uniqueTag.Value);
				if(localFile.Value != "")
					web.SaveToFile(localFile.Value);
			}
		}
	...
	public class DownloadVector3: FsmStateAction
	{
		...
		public override void OnUpdate()
		{
			...
			{
				Fsm.Event(isDownloaded);
				loadValue = web.Load<Vector3>(uniqueTag.Value);
				if(localFile.Value != "")
					web.SaveToFile(localFile.Value);
			}
		}
	...
	public class DownloadColor: FsmStateAction
	{
		...
		public override void OnUpdate()
		{
			...
			{
				Fsm.Event(isDownloaded);
				loadValue = web.Load<Color>(uniqueTag.Value);
				if(localFile.Value != "")
					web.SaveToFile(localFile.Value);
			}
		}
	...
	public class DownloadQuaternion : FsmStateAction
	{
		...
		public override void OnUpdate()
		{
			...
			{
				Fsm.Event(isDownloaded);
				loadValue = web.Load<Quaternion>(uniqueTag.Value);
				if(localFile.Value != "")
					web.SaveToFile(localFile.Value);
			}
		}
	...
	public class LoadInt : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			loadValue = ES2.Load<int>(saveFile+"?tag="+uniqueTag);
	...
	public class LoadFloat : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			loadValue = ES2.Load<float>(saveFile+"?tag="+uniqueTag);
			Log("Loaded from "+saveFile+"?tag="+uniqueTag);
			Finish();
		}
	}
	...
	public class LoadBool : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			loadValue = ES2.Load<bool>(saveFile+"?tag="+uniqueTag);
			Log("Loaded from "+saveFile+"?tag="+uniqueTag);
			Finish();
		}
	}
	...
	public class LoadString : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			loadValue = ES2.Load<string>(saveFile+"?tag="+uniqueTag);
			Log("Loaded from "+saveFile+"?tag="+uniqueTag);
			Finish();
		}
	}
	...
	public class LoadVector2 : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			loadValue = ES2.Load<Vector2>(saveFile+"?tag="+uniqueTag);
			Log("Loaded from "+saveFile+"?tag="+uniqueTag);
			Finish();
		}
	}
	...
	public class LoadVector3 : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			loadValue = ES2.Load<Vector3>(saveFile+"?tag="+uniqueTag);
			Log("Loaded from "+saveFile+"?tag="+uniqueTag);
			Finish();
		}
	}
	...
	public class LoadColor : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			loadValue = ES2.Load<Color>(saveFile+"?tag="+uniqueTag);
			Log("Loaded from "+saveFile+"?tag="+uniqueTag);
			Finish();
		}
	}
	...
	public class LoadQuaternion : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			loadValue = ES2.Load<Quaternion>(saveFile+"?tag="+uniqueTag);
			Log("Loaded from "+saveFile+"?tag="+uniqueTag);
			Finish();
		}
	}
